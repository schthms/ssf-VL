...
# python mmf/tools/scripts/features/lmdb_conversion.py --mode convert --lmdb_path food_features/imdb/ --features_folder food_features/all_features/
...
class LMDBConversion:
    ...
    def convert(self):
        ...
        with env.begin(write=True) as txn:
            with open('failed.log', 'w') as failed:
                for infile in tqdm.tqdm(features):
                    try:
                        ...
                        failed.write(infile.split('/')[-1].split('.')[0]+'\n')
