...
"""
  ...
  --model_file mmf/tools/scripts/features/frcnn/model.bin \
  --config_file mmf/tools/scripts/features/frcnn/config.yaml \
  --image_dir twitter_dataset/images/test --output_folder twitter_dataset/features_frcnn
"""
...
class FeatureExtractor:
    ...
    MODEL_URL = {
        "FRCNN": "https://s3.amazonaws.com/models.huggingface.co/bert/unc-nlp/frcnn-vg-finetuned/pytorch_model.bin"
