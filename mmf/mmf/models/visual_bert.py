...
class VisualBERTForClassification(nn.Module):
    ...
    def forward(
        ...
        if not torch.jit.is_scripting() and self.output_attentions and TO_PICKLE:
            pickle.dump(output_dict, open("/home/tschneider/pretraining-vl/results_viz/output_dict.pkl", "wb"))
            exit
        return output_dict
