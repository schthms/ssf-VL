...
# Run me with (update name!)   sbatch --gpus-per-node=4 vilBERT_twitter_COCO_full_direct.sh

# Set environment variables
echo "Setting environment variables..."
export RUN_NAME="vilBERT_twitter_COCO_full_direct_20k"
...
mmf_run config=projects/vilbert/configs/twitter/defaults.yaml \
    run_type=test \
    dataset=twitter \
    model=vilbert \
    training.fp16=True \
