...
# Run me with (update name!)   sbatch --gpus-per-node=4 twitter_COCO_less_self_super.sh

# Set environment variables
echo "Setting environment variables..."
export RUN_NAME="twitter_COCO_less_self_super_60k"
...
unzip -qn twitter.zip && unzip -q twitter_self_super.zip

# !!! CHOSE ONE !!!
# option 1: one of the label splits labels.jsonl or no_labels.jsonl
mv twitter_self_super/no_labels.jsonl twitter/defaults/annotations/train.jsonl
