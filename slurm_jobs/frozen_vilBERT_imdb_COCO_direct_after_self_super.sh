...
# Run me with (update name!)   sbatch --gpus-per-node=4 frozen_vilBERT_imdb_COCO_direct_after_self_super.sh

# Set environment variables
echo "Setting environment variables..."
export RUN_NAME="frozen_vilBERT_imdb_COCO_direct_after_self_super_20k"
...
mmf_run config=projects/vilbert/configs/mmimdb/defaults.yaml \
    ...
    model_config.vilbert.freeze_text=False \
    model_config.vilbert.v_target_size=1600
