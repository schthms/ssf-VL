...
# Run me with (update name!)   sbatch --gpus-per-node=4 twitter_099_001_COCO_self_super.sh

# Set environment variables
echo "Setting environment variables..."
export RUN_NAME="twitter_099_001_COCO_self_super_60k"
...
mmf_run config=projects/visual_bert/configs/twitter/pretrain.yaml \
    run_type=train \
