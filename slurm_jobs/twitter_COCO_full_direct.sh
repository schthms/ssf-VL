...
# Run me with (update name!)   sbatch --gpus-per-node=4 twitter_COCO_full_direct.sh

# Set environment variables
echo "Setting environment variables..."
export RUN_NAME="twitter_COCO_full_direct_20k"
...
# first run was with: checkpoint.resume=False \
