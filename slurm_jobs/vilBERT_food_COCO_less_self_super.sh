...
# Run me with (update name!)   sbatch --gpus-per-node=4 vilBERT_food_COCO_less_self_super.sh

# Set environment variables
echo "Setting environment variables..."
export RUN_NAME="food_vilBERT_COCO_less_self_super_40k"
...
mv food_self_super/no_labels.jsonl food101/defaults/annotations/train.jsonl
...
mmf_run config=projects/vilbert/configs/food101/pretrain.yaml \
    run_type=train \
    dataset=masked_food101 \
    model=vilbert \
    training.fp16=True \
    ...
    training.max_updates=40000 \
    scheduler.params.num_training_steps=40000 \
