...
# Run me with (update name!)   sbatch --gpus-per-node=4 frozen_vilBERT_imdb_direct_after_pretrain.sh

# Set environment variables
echo "Setting environment variables..."
export RUN_NAME="frozen_vilBERT_imdb_direct_after_self_super_20k"
