...
# Run me with (update name!)   sbatch --gpus-per-node=4 food_COCO_less_self_super.sh

# Set environment variables
echo "Setting environment variables..."
export RUN_NAME="food_COCO_less_self_super_40k"
...
mmf_run config=projects/visual_bert/configs/food101/pretrain.yaml \
    run_type=train \
