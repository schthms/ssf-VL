...
# Run me with (update name!)   sbatch --gpus-per-node=4 twitter_099_001_COCO_direct_after_self_super.sh

# Set environment variables
echo "Setting environment variables..."
export DATA="twitter"
export RUN_NAME=$DATA"_099_001_COCO_direct_after_pretrain_20k"
