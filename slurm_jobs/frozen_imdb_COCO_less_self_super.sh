...
# Run me with (update name!)   sbatch --gpus-per-node=4 frozen_imdb_COCO_less_self_super.sh

# Set environment variables
echo "Setting environment variables..."
export RUN_NAME="frozen_imdb_COCO_less_self_super_20k"
...
mmf_run config=projects/visual_bert/configs/mmimdb/pretrain.yaml \
    run_type=train \
