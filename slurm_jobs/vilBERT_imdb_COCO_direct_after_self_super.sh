...
# Run me with (update name!)   sbatch --gpus-per-node=4 vilBERT_imdb_COCO_direct_after_self_super.sh

# Set environment variables
echo "Setting environment variables..."
export RUN_NAME="vilBERT_imdb_COCO_direct_after_self_super_20k"
